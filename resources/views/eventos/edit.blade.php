                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="titulo" id="titulo"
                                ...
                                value="{{ $evento->titulo ?? @old('titulo') }}" required>
                            @error('titulo')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <textarea name="descricao" id="descricao" rows="2" class="form-control @error('descricao') is-invalid @enderror"
                                required>{{ $evento->descricao ?? @old('descricao') }}</textarea>
                            @error('descricao')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="date" name="data" id="data"
                                ...
                                value="{{ date($evento->data->format('Y-m-d')) ?? @old('data') }}" required>
                            @error('data')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="time" name="hora" id="hora"
                                ...
                                value="{{ $evento->hora ?? @old('hora') }}" required>
                            @error('hora')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="endereco" id="endereco"
                                ...
                                value="{{ $evento->endereco ?? @old('endereco') }}" required>
                            @error('endereco')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="bairro" id="bairro"
                                ...
                                value="{{ $evento->bairro ?? @old('bairro') }}" required>
                            @error('bairro')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="cep" id="cep"
                                ...
                                value="{{ $evento->cep ?? @old('cep') }}" required>
                            @error('cep')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <select name="estado_id" id="estado"
                                ...
                                @foreach ($estados as $estado)
                                    <option value="{{ $estado->id }}" @if ($evento->cidade->estado->id == $estado->id) selected @endif>
                                        {{ $estado->nome }}</option>
                                @endforeach
                            </select>
                            @error('estado')
                            ...
                            <select name="cidade_id" id="cidade"
                                ...
                                @foreach ($cidades as $cidade)
                                    <option value="{{ $cidade->id }}"
                                        @if ($evento->cidade->id == $cidade->id) selected @endif>
                                        {{ $cidade->nome }}</option>
                                @endforeach
                            </select>
                            @error('cidade')
                            ...
                            <select name="grupo_id" id="grupo_id"
                                ...
                                @foreach ($grupos as $grupo)
                                    <option value="{{ $grupo->id }}"
                                        @if ($evento->grupo_id == $grupo->id) selected @endif>
                                        {{ $grupo->nome }}
                                    </option>
                                @endforeach
                            </select>
